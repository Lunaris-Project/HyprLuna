    ...
    return Box({
        ...
        children: [
                ...
                children: [
                    Label({
                        ...
                        setup: (self) => self.poll(userOptions.asyncGet().time.interval, label => {
                            label.label = GLib.DateTime.new_now_local().format(userOptions.asyncGet().time.format + " %p");
                        }),
                    }),
                ]
            }),
            ...
            Label({
                ...
                xalign: 0,
                setup: self => self.hook(WeatherService, () => {
                    self.label = `Feels ${WeatherService.feelsLike} in ${userOptions.asyncGet().weather.city}`;
                })
            }),
        ]
    });
